...
if __name__ == '__main__':
    folder_path = 'data/2011_09_26/2011_09_26_drive_0005_sync/image_03'
    frames = [cv2.imread(os.path.join(folder_path, 'data', rf'0000000{str(i).zfill(3)}.png')) for i in range(154)]
    timestamps = ToolBox.read_timestamps_from_file(os.path.join(folder_path, 'timestamps.txt'))
